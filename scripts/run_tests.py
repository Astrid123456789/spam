#!/usr/bin/env python3
"""
Test Runner Script for Spam ML Pipeline with Cryptographic Proof

This script provides a comprehensive test runner for validating the technical
implementation of the Spam ML Pipeline components, now enhanced with
...
class TestRunner:
    """Professional test runner for the Spam ML Pipeline with crypto support."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run technical validation tests for Spam ML Pipeline",
...
Examples:
  ...
  python scripts/run_tests.py --no-proof         # Skip proof generation
    ...
    # Print header
    runner.print_header("Spam ML Pipeline - Test Runner with Crypto Verification")
